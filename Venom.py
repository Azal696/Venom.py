...
vuln = '\x1b[32mVuln'
os.system('clear')
logo = '--------------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author   : </>Fsociety/>     \n\x1b[1;97m\xe2\x9e\xa3 Discord invite  : discord.gg/robot \n\x1b[1;97m\xe2\x9e\xa3 ME   @Fsociety:\n\x1b[1;97m\xe2\x9e\xa3 Note  :Slawtan le be xoshawestan ema wak staffi (Robot) Hastayn ba drust krdne am toola bo eway xoshawest wa am toola edit krawa la layan (Robot°Venom) (Robot°1616) wa harkasek har karek bka bam toola ema ley bar prs nin Serveri Shaxse Robot (discord.gg/robot) Ama Taka serverka he robot be owner am servera (Robot°DJ) (Robot°MrFOG) harkasek keshay habu la toolakaatwani nama bo (Robot°Venom)(Robot°1616) amanji robot xzmata \n\x1b[1;97m--------------------------------------------------\n'
logo2 = ""
